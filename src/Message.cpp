...
const std::unordered_map<LocaleConstant, std::string> AB_WORLD_HEALTH_MULTIPLIER = {
    {LOCALE_enUS, "World health multiplier: {}|r"},
    {LOCALE_koKR, "월드 체력 배율: {}|r"},
    {LOCALE_frFR, "Multiplicateur de santé mondiale : {}|r"},
    {LOCALE_deDE, "Weltgesundheitsmultiplikator: {}|r"},
    {LOCALE_zhCN, "全局生命值倍率：{}|r"},
    {LOCALE_zhTW, "全局生命值倍增器：{}|r"},
    {LOCALE_esES, "Multiplicador de salud mundial: {}|r"},
    {LOCALE_esMX, "Multiplicador de salud mundial: {}|r"},
    {LOCALE_ruRU, "Множитель здоровья мира: {}|r"},
};

const std::unordered_map<LocaleConstant, std::string> AB_WORLD_HOSTILE_DAMAGE_HEALING_MULTIPLIER_TO = {
    {LOCALE_enUS, "World hostile damage and healing multiplier: {} -> {}|r"},
    {LOCALE_koKR, "월드 적 대미지 및 치유 배율: {} -> {}|r"},
    {LOCALE_frFR, "Multiplicateur de dégâts et de soins hostiles mondiaux : {} -> {}|r"},
    {LOCALE_deDE, "Weltweiter feindlicher Schadens- und Heilungs-Multiplikator: {} -> {}|r"},
    {LOCALE_zhCN, "全局伤害和治疗倍率：{} -> {}|r"},
    {LOCALE_zhTW, "全局敵對傷害和治療倍增器：{} -> {}|r"},
    {LOCALE_esES, "Multiplicador de daño y curación hostil mundial: {} -> {}|r"},
    {LOCALE_esMX, "Multiplicador de daño y curación hostil mundial: {} -> {}|r"},
    {LOCALE_ruRU, "Множитель урона и лечения мира: {} -> {}|r"},
};
...
const std::unordered_map<LocaleConstant, std::string> AB_ORIGINAL_CREATURE_LEVEL_RANGE = {
    {LOCALE_enUS, "Original Creature Level Range: {} - {} (Avg: {})|r"},
    {LOCALE_koKR, "원래 크리쳐 레벨 범위: {} - {} (평균: {})|r"},
    {LOCALE_frFR, "Plage de niveaux de créatures d'origine : {} - {} (Moyenne : {})|r"},
    {LOCALE_deDE, "Originaler Kreaturenlevelbereich: {} - {} (Durchschnitt: {})|r"},
    {LOCALE_zhCN, "原始生物等级范围：{} - {}（平均：{}）|r"},
    {LOCALE_zhTW, "原始生物等級範圍：{} - {}（平均：{}）|r"},
    {LOCALE_esES, "Rango de niveles de criaturas originales: {} - {} (Promedio: {})|r"},
    {LOCALE_esMX, "Rango de niveles de criaturas originales: {} - {} (Promedio: {})|r"},
    {LOCALE_ruRU, "Исходный диапазон уровней существ: {} - {} (Среднее: {})|r"},
};
...
const std::unordered_map<LocaleConstant, std::string> AB_HEALTH_MULTIPLIER_TO = {
    {LOCALE_enUS, "Health multiplier: {} -> {}|r"},
    {LOCALE_koKR, "체력 배율: {} -> {}|r"},
    {LOCALE_frFR, "Multiplicateur de santé : {} -> {}|r"},
    {LOCALE_deDE, "Gesundheitsmultiplikator: {} -> {}|r"},
    {LOCALE_zhCN, "生命值倍率：{} -> {}|r"},
    {LOCALE_zhTW, "生命值倍增器：{} -> {}|r"},
    {LOCALE_esES, "Multiplicador de salud: {} -> {}|r"},
    {LOCALE_esMX, "Multiplicador de salud: {} -> {}|r"},
    {LOCALE_ruRU, "Множитель здоровья: {} -> {}|r"},
};

const std::unordered_map<LocaleConstant, std::string> AB_MANA_MULTIPLIER_TO = {
    {LOCALE_enUS, "Mana multiplier: {} -> {}|r"},
    {LOCALE_koKR, "마나 배율: {} -> {}|r"},
    {LOCALE_frFR, "Multiplicateur de mana : {} -> {}|r"},
    {LOCALE_deDE, "Manamultiplikator: {} -> {}|r"},
    {LOCALE_zhCN, "法力值倍率：{} -> {}|r"},
    {LOCALE_zhTW, "法力值倍增器：{} -> {}|r"},
    {LOCALE_esES, "Multiplicador de maná: {} -> {}|r"},
    {LOCALE_esMX, "Multiplicador de maná: {} -> {}|r"},
    {LOCALE_ruRU, "Множитель маны: {} -> {}|r"},
};

const std::unordered_map<LocaleConstant, std::string> AB_ARMOR_MULTIPLIER_TO = {
    {LOCALE_enUS, "Armor multiplier: {} -> {}|r"},
    {LOCALE_koKR, "방어구 배율: {} -> {}|r"},
    {LOCALE_frFR, "Multiplicateur d'armure : {} -> {}|r"},
    {LOCALE_deDE, "Rüstungsmultiplikator: {} -> {}|r"},
    {LOCALE_zhCN, "护甲倍率：{} -> {}|r"},
    {LOCALE_zhTW, "護甲倍增器：{} -> {}|r"},
    {LOCALE_esES, "Multiplicador de armadura: {} -> {}|r"},
    {LOCALE_esMX, "Multiplicador de armadura: {} -> {}|r"},
    {LOCALE_ruRU, "Множитель брони: {} -> {}|r"},
};

const std::unordered_map<LocaleConstant, std::string> AB_DAMAGE_MULTIPLIER_TO = {
    {LOCALE_enUS, "Damage multiplier: {} -> {}|r"},
    {LOCALE_koKR, "피해 배율: {} -> {}|r"},
    {LOCALE_frFR, "Multiplicateur de dégâts : {} -> {}|r"},
    {LOCALE_deDE, "Schadensmultiplikator: {} -> {}|r"},
    {LOCALE_zhCN, "伤害倍率：{} -> {}|r"},
    {LOCALE_zhTW, "傷害倍增器：{} -> {}|r"},
    {LOCALE_esES, "Multiplicador de daño: {} -> {}|r"},
    {LOCALE_esMX, "Multiplicador de daño: {} -> {}|r"},
    {LOCALE_ruRU, "Множитель урона: {} -> {}|r"},
};
...
const std::unordered_map<LocaleConstant, std::string> AB_CC_DURATION_MULTIPLIER = {
    {LOCALE_enUS, "CC Duration multiplier: {}|r"},
    {LOCALE_koKR, "CC 지속시간 배율: {}|r"},
    {LOCALE_frFR, "Multiplicateur de durée de la CC : {}|r"},
    {LOCALE_deDE, "CC-Dauer-Multiplikator: {}|r"},
    {LOCALE_zhCN, "控制持续时间倍率：{}|r"},
    {LOCALE_zhTW, "控制持續時間倍增器：{}|r"},
    {LOCALE_esES, "Multiplicador de duración de CC: {}|r"},
    {LOCALE_esMX, "Multiplicador de duración de CC: {}|r"},
    {LOCALE_ruRU, "Множитель длительности контроля: {}|r"},
};

const std::unordered_map<LocaleConstant, std::string> AB_XP_MONEY_MULTIPLIER = {
    {LOCALE_enUS, "XP multiplier: {}  Money multiplier: {}|r"},
    {LOCALE_koKR, "경험치 배율: {}  돈 배율: {}|r"},
    {LOCALE_frFR, "Multiplicateur d'XP : {}  Multiplicateur d'argent : {}|r"},
    {LOCALE_deDE, "XP-Multiplikator: {}  Geldmultiplikator: {}|r"},
    {LOCALE_zhCN, "经验值倍率：{}  金钱倍率：{}|r"},
    {LOCALE_zhTW, "經驗值倍增器：{}  金錢倍增器：{}|r"},
    {LOCALE_esES, "Multiplicador de XP: {}  Multiplicador de dinero: {}|r"},
    {LOCALE_esMX, "Multiplicador de XP: {}  Multiplicador de dinero: {}|r"},
    {LOCALE_ruRU, "Множитель опыта: {}  Множитель денег: {}|r"},
};
